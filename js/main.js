/*=============================================================
Template Name: Columbus Heights - Hotel HTML Template
...
(function($) {
  ...
  $(document).ready(function() {
    ...
    function initialize() {
      var map;
      var panorama;
      var var_latitude = 18.406441; // Google Map Latitude
      var var_longitude = -77.11328; // Google Map Longitude
      var pin = 'images/icons/pin.svg';

      //Map pin-window details
      var title = "Columbus Heights - Click to see";
      var hotel_name = "Columbus Heights";
      var hotel_address = "Columbus Heights,P.O Box 383, Ocho Rios";
      var hotel_desc = "Deluxe Hotel";
      var hotel_more_desc = "A wonderful Piece of Jamaica";
